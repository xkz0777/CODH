...
# set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { rotateR }]; #IO_L9P_T1_DQS_14 Sch=btnc
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { rotateR }]; #IO_L4N_T0_D05_14 Sch=btnu
...
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { verticalspeed }]; #IO_L9N_T1_DQS_D13_14 Sch=btnd
