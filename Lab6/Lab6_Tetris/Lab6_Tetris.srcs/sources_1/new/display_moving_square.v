...
module display_moving_square(
        ...
        input[10:0] h,
        input[10:0] v,
        input[15:0] enable_moving,                  //  方块寄存器
    ...
    always@(posedge clk or negedge rst_n) begin
        ...
        else if(enable_moving[0] == 1'b1) begin
    ...
    always@(posedge clk or negedge rst_n) begin
        ...
        else if(enable_moving[1] == 1'b1) begin
    ...
    always@(posedge clk or negedge rst_n) begin
        ...
        else if(enable_moving[2] == 1'b1) begin
    ...
    always@(posedge clk or negedge rst_n) begin
        ...
        else if(enable_moving[3] == 1'b1) begin
    ...
    always@(posedge clk or negedge rst_n) begin
        ...
        else if(enable_moving[4] == 1'b1) begin
            if(col_addr_sig == h - 11'd2)
    ...
    always@(posedge clk or negedge rst_n) begin
        ...
        else if(enable_moving[5] == 1'b1) begin
            if(col_addr_sig == h + 11'd18)
    ...
    always@(posedge clk or negedge rst_n) begin
        ...
        else if(enable_moving[6] == 1'b1) begin
            if(col_addr_sig == h + 11'd38)
    ...
    always@(posedge clk or negedge rst_n) begin
        ...
        else if(enable_moving[7] == 1'b1) begin
            if(col_addr_sig == h + 11'd58)
    ...
    always@(posedge clk or negedge rst_n) begin
        ...
        else if(enable_moving[8] == 1'b1) begin
            if(col_addr_sig == h - 11'd2)
    ...
    always@(posedge clk or negedge rst_n) begin
        ...
        else if(enable_moving[9] == 1'b1) begin
            if(col_addr_sig == h + 11'd18)
    ...
    always@(posedge clk or negedge rst_n) begin
        ...
        else if(enable_moving[10] == 1'b1) begin
            if(col_addr_sig == h + 11'd38)
    ...
    always@(posedge clk or negedge rst_n) begin
        ...
        else if(enable_moving[11] == 1'b1) begin
            if(col_addr_sig == h + 11'd58)
    ...
    always@(posedge clk or negedge rst_n) begin
        ...
        else if(enable_moving[12] == 1'b1) begin
            if(col_addr_sig == h - 11'd2)
    ...
    always@(posedge clk or negedge rst_n) begin
        ...
        else if(enable_moving[13] == 1'b1) begin
            if(col_addr_sig == h + 11'd18)
    ...
    always@(posedge clk or negedge rst_n) begin
        ...
        else if(enable_moving[14] == 1'b1) begin
            if(col_addr_sig == h + 11'd38)
    ...
    always@(posedge clk or negedge rst_n) begin
        ...
        else if(enable_moving[15] == 1'b1) begin
            if(col_addr_sig == h + 11'd58)
