...
module square_gen(
    ...
    always@(posedge clk or negedge rst_n) begin
        ...
        else if(rotate_r_dly && (~rotate_en)) begin
            enable_moving_rotate <= enable_moving_r;
        end
        else if(rotate_r_dly||rotate_r) begin
    ...
    always@(posedge clk or negedge rst_n) begin
        ...
        else if(loading_square) begin
            case(square_type)
                3'b000:
                    enable_moving_r <= 16'b0000_0111_0010_0000;
                3'b001:
                    enable_moving_r <= 16'b0000_0110_0110_0000;
                3'b010:
                    enable_moving_r <= 16'b0010_0010_0010_0010;
                3'b011:
                    enable_moving_r <= 16'b0000_0011_0110_0000;
                3'b100:
                    enable_moving_r <= 16'b0000_0110_0011_0000;
                3'b101:
                    enable_moving_r <= 16'b0000_0011_0010_0010;
                3'b110:
                    enable_moving_r <= 16'b0000_0011_0001_0001;
                default:
                    enable_moving_r <= 16'b0000_0110_0110_0000;
            endcase
        end
