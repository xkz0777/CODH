...
blt t4, t5, CONTINUE # if array[j] < array[min_index] skip next
jal ADD
CONTINUE:
add t3, t2, zero
ADD:
...
PRINT:
addi t0, zero, 0xff # t0: 0x0000ff00, base mmio address
slli t0, t0, 8
add t1, zero, zero
addi t2, zero, 256

WAIT: # Check if seg is ready
lw t3, 0x8(t0)
beq t3, zero, WAIT

slli t3, t1, 2
lw t5, (t3) # Load a word
sw t5, 0xc(t0) # Store a word
addi t1, t1, 1
blt t1, t2, WAIT
